...
local CustomPortraitRendererService = class()
local log = radiant.log.create_logger('log')
log:always("customPortrait loaded")
function CustomPortraitRendererService:_stage_scene(options, scene_root, camera)
